...
SQL;
  ...
  function posts($category = ''){
    ...
    $mysql = new Mysql();
    $sql = <<<SQL
    SELECT * FROM contenido_ordenado WHERE tipo = 'POST' $where
SQL;
...
SQL;
  ...
  function categorias(){
    ...
    $mysql = new Mysql();
    $sql = <<<SQL
    SELECT DISTINCT categoria FROM contenidos
SQL;
  ...
  function paginas(){
    ...
    $mysql = new Mysql();
    $sql = <<<SQL
    SELECT titulo FROM contenidos WHERE tipo = "PAGE"
SQL;
  ...
  function paginas_alias($pagina){

    $mysql = new Mysql();
    $sql = <<<SQL
    SELECT alias FROM contenidos WHERE titulo = "$pagina"
SQL;
